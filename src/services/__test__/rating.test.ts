...
describe('Rating service', () => {
  ...
  describe('Get rating based on swell height', () => {
    it('should get a rating 1 for less then ankle to knee hight swell', () => {
      const rating = defaultRating.getRatingForSwellSize(0.2);
      expect(rating).toBe(1);
    });

    it('should get a rating 2 for less then ankle to knee hight swell', () => {
      const rating = defaultRating.getRatingForSwellSize(0.6);
      expect(rating).toBe(2);
    });

    it('should get a rating 3 for less then ankle to knee hight swell', () => {
      const rating = defaultRating.getRatingForSwellSize(1.5);
      expect(rating).toBe(3);
    });

    it('should get a rating 5 for less then ankle to knee hight swell', () => {
